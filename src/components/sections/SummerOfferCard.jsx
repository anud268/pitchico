...
export default function SummerOfferCard() {
  return (
    <div className="relative w-full max-w-[380px] rounded-[2.5rem] p-2.5 md:p-3 bg-gold/70 backdrop-blur-xl  shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] group transition-all duration-[800ms] hover:shadow-[0_40px_80px_-20px_rgba(184,134,11,0.25)] hover:-translate-y-2">
        ...
        <div className="px-8 pb-8 pt-7 relative z-20">
          <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-6">
            <div>
              ...
              <h4 className="text-2xl font-display font-bold text-dark">Up to 50% Off</h4>
            </div>
